...
COMPONENT_LDFLAGS += -L$(BUILD_DIR_BASE)/bt -lbt -L $(IDF_PATH)/components/bt/controller/lib/esp32 -lbtdm_app
COMPONENT_LINKER_DEPS += $(IDF_PATH)/components/bt/controller/lib/esp32/libbtdm_app.a
